...
class Detector:
    def __init__(self, det_name: str = 'scrfd_10g_gnkps', max_size=None,
        ...
        self.retina = get_model(det_name, backend_name=backend_name, force_fp16=force_fp16, im_size=max_size,
                                root_dir=root_dir, download_model=True, triton_uri=triton_uri,
...
class FaceAnalysis:
    def __init__(self, det_name: str = 'scrfd_10g_gnkps', rec_name: str = 'glintr100',
                 ...
                 backend_name: str = 'onnx', force_fp16: bool = False, triton_uri=None, root_dir: str = '/nas/dominic/Production/FaceModel_REST/InsightFace-REST/models'):
        ...
        if rec_name is not None:
            self.rec_model = get_model(rec_name, backend_name=backend_name, force_fp16=force_fp16,
                                       ...
                                       download_model=True, triton_uri=triton_uri)
