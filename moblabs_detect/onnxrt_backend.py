...
class DetectorInfer:
    ...
    def __init__(self, model='/models/onnx/scrfd_10g_gnkps/scrfd_10g_gnkps.onnx',
        ...
        self.det_model = onnxruntime.InferenceSession(model, providers=["CUDAExecutionProvider", "CPUExecutionProvider"])
        ...
        self.input_shape = (1,3,640,640) #tuple(self.input.shape)
    ...
    def prepare(self, **kwargs):
        ...
        self.det_model.run(self.output_order,
